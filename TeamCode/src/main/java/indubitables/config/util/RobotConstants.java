...
public class RobotConstants {
    ...
    public static double outtakeRotateTransfer = 0.35; //.25
    ...
    public static double outtakePivotTransfer= 0.245; //.05
    ...
    public static double intakeRotateTransfer = 0.75;
    public static double intakeRotateHover = 0.3;
    public static double intakeRotateGroundVertical = 0.37;
    public static double intakeRotateLeftGroundHorizontal = 0.28;
    public static double intakeRotateRightGroundHorizontal = 0.46;
    public static double intakePivotTransfer= 0.35;
    public static double intakePivotGround = 0.65;
    public static double intakePivotHover = 0.56;
