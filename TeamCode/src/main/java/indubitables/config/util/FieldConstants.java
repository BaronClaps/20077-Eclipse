...
public class FieldConstants {
    ...
    public static final Pose blueBucketStartPose = new Pose(8, 78.375, Math.toRadians(180));
    ...
    // Blue Preload Poses
    public static final Pose blueBucketPreloadPose = new Pose(34.5, 78.375, Math.toRadians(180));
