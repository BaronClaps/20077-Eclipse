...
public class FieldConstants {
    ...
    public static final Pose blueObservationSpecimenSetPose = new Pose(21, 25.75, Math.toRadians(0));
    public static final Pose blueObservationSpecimenPickupPose = new Pose(17, 25.75, Math.toRadians(0));
    public static final Pose blueObservationSpecimenPickup2Pose = new Pose(17.25, 25.75, Math.toRadians(0));
