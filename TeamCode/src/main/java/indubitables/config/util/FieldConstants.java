...
public class FieldConstants {
    ...
    public static final Pose observationSpecimenPickupPose = new Pose(6.75, 37, Math.toRadians(180));
    public static final Pose observationSpecimenPickup2Pose = new Pose(6.75, 37, Math.toRadians(180));
    public static final Pose observationSpecimenPickup3Pose = new Pose(6.75, 37, Math.toRadians(180));
    public static final Pose observationSpecimenPickup4Pose = new Pose(6.75, 37, Math.toRadians(180));

    public static final Pose observationSpecimen1Pose = new Pose(38, 76, Math.toRadians(180));
    public static final Pose observationSpecimen2Pose = new Pose(38, 79.75, Math.toRadians(180));
    public static final Pose observationSpecimen3Pose = new Pose(38, 82.25, Math.toRadians(180));
    public static final Pose observationSpecimen4Pose = new Pose(38, 85.25, Math.toRadians(180));

    public static final Pose observationParkPose = new Pose(24, 44, Math.toRadians(215));
