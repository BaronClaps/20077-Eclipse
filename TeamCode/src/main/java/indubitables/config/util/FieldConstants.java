...
public class FieldConstants {
    ...
    public static final Pose blueObservationSpecimen1Pose = new Pose(34, 68.625, Math.toRadians(180));
    public static final Pose blueObservationSpecimen2Pose = new Pose(34, 71.625, Math.toRadians(180));
